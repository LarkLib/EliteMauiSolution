...
namespace Elite.LMS.Maui.WmsModules.CollectionView.Data;
...
#if IOS
            File.Copy("WmsModules/CollectionView/Data/contacts.db", this.DBPath);
#else
            var file = File.Create(this.DBPath);
            var task = FileSystem.Current.OpenAppPackageFileAsync("WmsModules/CollectionView/Data/contacts.db");
            task.Wait();
