...
namespace Elite.LMS.Maui.ViewModels {
    public class PhoneListViewModel : NavigationViewModelBase {
        ...
        ImageSource GetGroupIconSource(string groupName) {
            switch (groupName) {
                case "Star":
                    return ImageSource.FromFile("wmstabview_star");
                case "Work":
                    return ImageSource.FromFile("wmstabview_work");
                case "Family":
                    return ImageSource.FromFile("wmstabview_family");
                case "All":
                    return ImageSource.FromFile("wmstabview_all");
                default:
                    return string.Empty;
            }
        }
